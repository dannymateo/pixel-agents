...
- `e2e/claude/hooks-off/livingOffice.spec.ts:50` — living office: a team gets a named module, completed stays, killed walks out and frees it (Hooks OFF / living office)
